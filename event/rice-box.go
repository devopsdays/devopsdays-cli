...
func init() {
	...
	file2 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1507328668, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   ``,
		DirModTime: time.Unix(1507328668, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			file2, // conduct.md.tmpl
			file3, // contact.md.tmpl
			file4, // index.md.tmpl
			file5, // location.md.tmpl
			file6, // program.md.tmpl
			file7, // propose.md.tmpl
			file8, // registration.md.tmpl
			file9, // sponsor.md.tmpl
	...
	embedded.RegisterEmbeddedBox(`templates`, &embedded.EmbeddedBox{
		...
		Files: map[string]*embedded.EmbeddedFile{
			...
			"index.md.tmpl":        file4,
			"location.md.tmpl":     file5,
			"program.md.tmpl":      file6,
			"propose.md.tmpl":      file7,
			"registration.md.tmpl": file8,
			"sponsor.md.tmpl":      file9,
		},
	})
}
